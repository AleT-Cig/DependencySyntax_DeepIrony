...
class Features_manager(object):
    ...
    def __init__(self):
        ...
        """
        # relationformVERB Sidorovbigramsdeprel Sidorovbigramsupostag chargrams relationformADJ
        self.global_feature_types_list={
            "unigrams": self.get_unigrams_features,
    ...
    def get_unigrams_features(self, tweets,tweet_test=None):
        """
    ...
    def get_deprelneg_features(self, tweets, tweet_test=None):
        # Se la feat =Neg, vado a prendere la deprel corrispondente
        # 6	nn	non	ADV	BN	PronType=Neg	9	advmod	_	_
        # BoW delle deprel
        """
        :param tweets: Array of  Tweet objects. Training set.
        :param tweet_test: Optional Array of  Tweet objects. Test set.
